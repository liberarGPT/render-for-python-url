...
from webui.components.chatbot_panel import create_chatbot_panel # Import the new chatbot panel
from webui.components.rss_ticker_feed import create_rss_ticker_feed_layout # Import the RSS ticker feed
from webui.components.trending_tickers import create_trending_tickers_layout # Import the trending tickers
...
def create_main_layout():
    ...
    chatbot_card = create_chatbot_panel() # Instantiate the new chatbot panel
    rss_feed_card = create_rss_ticker_feed_layout() # Instantiate the RSS ticker feed
    trending_card = create_trending_tickers_layout() # Instantiate the trending tickers
    ...
    layout = dbc.Container(
        [
            ...
            *create_stores(),
            ...
            # Main content
            header,
            rss_feed_card, # Add RSS ticker feed at the top
            chatbot_card, # Add chatbot directly below RSS feed
            trending_card, # Add trending tickers below chatbot
            alpaca_account_card,
            dbc.Row([
